...
const Pagination = ({sumProduct, limit, setPages}) => {
    // Tính tổng số trang = (Tổng sp : limit)
    const pageCount = Math.ceil(sumProduct / limit)
  ...
  return (
    <ReactPaginate
      ...
      pageCount={pageCount} //Tổng số trang   *****
