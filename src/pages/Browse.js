          ...
          <div className="page-content">
              ...
              <div className="col-lg-4">
                <div className="top-downloaded">
                  ...
                  <div className="text-button">
                    <Link to="profile.html">View All Games</Link>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="row">
                  <div className="col-lg-4">
                    <div className="item">
                      ...
                      <p>
                        ...
                        by TemplateMo. This is Bootstrap v5.2.0 layout.
                      </p>
                    </div>
                  </div>
                  <div className="col-lg-4">
                  ...
                  <div className="col-lg-12">
                    <div className="main-button">
                      <Link to="profile.html">Go To Profile</Link>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="live-stream">
              ...
              <div className="row">
                <div className="col-lg-3 col-sm-6">
                  <div className="item">
                      ...
                      <div className="hover-effect">
                        <div className="content">
                          ...
                          <ul>
                            <li>
                              <Link to="#">
                                <span className="fa fa-eye"></span> 1.2K
                              </Link>
                            </li>
                            <li>
                              <Link to="#">
                                <span className="fa fa-gamepad"></span> CS-GO
                              </Link>
                            </li>
                          </ul>
                        </div>
                    ...
                    <div className="down-content">
                      ...
                      <span>
                        <span className="fa fa-check"></span> KenganC
                      </span>
                ...
                <div className="col-lg-3 col-sm-6">
                  <div className="item">
                    ...
                    <div className="down-content">
                      ...
                      <span>
                        <span className="fa fa-check"></span> LunaMa
                      </span>
                ...
                <div className="col-lg-3 col-sm-6">
                  <div className="item">
                    ...
                    <div className="down-content">
                      ...
                      <span>
                        <span className="fa fa-check"></span> Areluwa
                      </span>
                ...
                <div className="col-lg-3 col-sm-6">
                  <div className="item">
                    ...
                    <div className="down-content">
                      ...
                      <span>
                        <span className="fa fa-check"></span> GangTm
                      </span>
                ...
                <div className="col-lg-12">
                  <div className="main-button">
                    <Link to="streams.html">Discover All Streams</Link>
                  </div>
                </div>
              </div>
            </div>
